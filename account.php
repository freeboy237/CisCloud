        ...
        <div class="main-panel">
          <div class="content-wrapper">
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5"><?php $query=('SELECT * FROM compte WHERE id_user="'.$_SESSION['userid'].'"'); $query= $connx->prepare($query);$query->execute();$re=$query->fetch(); echo $re['montant']; ?> XAF</h2>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                ...
                <div class="card">
                  <div class="card-body">
                    <center><h4 class="card-title"><i class="mdi mdi-pill"></i>Top Up</h4>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo $_SESSION['username']; ?>" aria-label="Username" aria-describedby="basic-addon1" readonly />
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text bg-gradient-primary text-white">XAF</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)">
                        <div class="input-group-append">
                          <span class="input-group-text">Dépot</span>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="Nom d'utilisateur du Destinataire" aria-label="Recipient's username" aria-describedby="basic-addon2">
                        <div class="input-group-append">
                          <button class="btn btn-sm btn-gradient-primary" type="button"><i class="mdi mdi-radar"></i></button>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <button class="btn btn-sm btn-outline-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Opérations</button>
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Transfert</a>
                            <a class="dropdown-item" href="#">Crédit numériques</a>
                            <a class="dropdown-item" href="#">Retrait Mobiles</a>
                            <div role="separator" class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#">CashLink(CL°)</a>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="Reseau Local Privé" aria-label="Recipient's username" aria-describedby="basic-addon2">
                        <div class="input-group-append">
