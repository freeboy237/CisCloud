    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="kdrive.jpg" alt="logo" style="border-radius:45px;"/></a>
          ...
          <div class="content-wrapper">
            ...
            <?php 
                if(isset($_GET['nom'],$_GET['v_mdp'])){
                    ...
                    $id=time();
                    if($mdp==$v_mdp){
                    $stmt=('INSERT INTO `formateur`(`id`,`id_struc`, `nom`, `prenom`, `specialite`, `niveau`, `tel`, `mdp`, `email`, `assignation`, `timestamp`) VALUES ("'.$id.'","'.$_SESSION['userid'].'","'.$nom.'"," "," ","'.$grade.'"," ", "'.$mdp.'","'.$email.'","'.$poste.'","'.$id.'" )');
                        ...
                        if($stmt->execute()){
                            ...
                            $messages="<b class=\"btn btn-danger\">Une erreur est survenue lors de l'envoie</b>";
                        }
                    }else{
            ...
            <div class="col-md-6 grid-margin stretch-card">
                ...
                <div class="card">
                <div class="card-body">
                    <center><h4 class="card-title">Personnel Register form</h4>
                    <p class="card-description"> <img src="kdrive.jpg" width="150px" style="border-radius:15px;"/></p></center>
                    <form class="forms-sample" style="font-weight:bold;" method="GET" action="#">
                    <div class="form-group">
                        <label for="exampleInputUsername1">Nom de l'agent</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="nom de l'agent" name="nom">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Poste</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Poste" name="poste">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1">créer lui un Mot de passe </label>
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="exampleInputConfirmPassword1" placeholder="Password" name="v_mdp">
                      </div>
                      <div class="form-check form-check-flat form-check-primary">
                        <label class="form-check-label">
                          <input type="checkbox" class="form-check-input" name="grade" checked value="4"> Role administrateur</label>
                      </div>
                      <button type="submit" class="btn btn-gradient-danger me-2">Submit</button>
