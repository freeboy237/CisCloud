...
<html lang="en">
  <head>
    ...
    <title>Rapport historique Kdrive</title>
    <!-- plugins:css -->
...
?>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <?php
          $id=$_SESSION['userid'];
          $dn1 = 'select * from acivity_log where id_users="'.$id.'"';
          $dn1 = $connx->prepare($dn1);
          $dn1 -> execute();
         $dn1= $dn1->fetch();
         ?>
<h5>Session record <?php echo date('D/M/Y h:i:s');?></h5>
...
<table class="table table-striped">
	<tr>
    	<th class="forum_tops">id_action</th>
    	<th class="forum_auth">action</th>
...
$dn1= $connx->prepare($dn1);
$dn1->execute();
while($dnn2 = $dn1->fetch())
{
?>
	<tr>
    	<td class="text-capitalize"><h5><a href="read_topic.php?id=<?php echo $dnn2['id_act']; ?>" class="btn"><i class="mdi mdi-file icon-lg"></i><?php echo htmlentities($dnn2['action'], ENT_QUOTES, 'UTF-8'); ?></a></h5></td>
    	<td>
      <?php  if($dnn2['id_act']!='')
{
?>
	<img src="assets/images/delete.png" alt="image perso" style="max-width:100px;max-height:100px;" />
<?php
}
?>
        <a href="profile.php?id=<?php echo $dnn2['id_act']; ?>" class="btn">&nbsp;Détails</a></td>
    	<td><?php echo date('d/m/Y H:i:s' ,$dnn2['timestamp']); ?></td>
<?php
if(isset($_SESSION['username']) and $dn['grade']==1)
{
?>
    	<td><a href="delete_topic.php?id=<?php echo $dnn2['id_act']; ?>"><img src="assets/images/delete.png" alt="Delete" /></a></td>
<?php
}
?>
    </tr>
