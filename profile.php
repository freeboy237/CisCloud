...
{
	$id = intval($_GET['id']);
    $dn = ('select nom, email, avatar, timestamp from users where id="'.$id.'"');
    $dn = $connx->prepare($dn);
    $dn->execute();
    $dn = $dn->fetch();
	//$dn = mysql_query;
	if(($dn)>0)
	{
        $dn1 = ('select nom, email, avatar, timestamp from users where id="'.$id.'"');
    ...
    <div class="container-scroller">
     ...
     <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="kdrive.jpg" alt="logo" style="border-radius:15px;"/></a>
...
{
?>
<br /><div class="center"><a href="edit_profile.php" class="btn btn-primary"><i class="mdi mdi-table-edit"></i>Modifier mon profil</a></div>
...
{
?>
	<img src="pages/samples/avatar/<?php echo $dnn['avatar']; ?>" alt="image perso" style="max-width:100px;max-height:100px;" />
<?php
}
else
{
...
?></td>
    	...
    	<b><br/>Email: <?php echo htmlentities($dnn['email'], ENT_QUOTES, 'UTF-8'); ?><br /></b>
      <br/><i>Cet utilisateur s'est inscrit le <?php echo date('d/m/Y - h:i:s',$dnn['timestamp']); ?></i></td>
    </tr>
</table>
<?php
if(isset($_SESSION['username']) and $_SESSION['username']!=$dnn['nom'])
{
?>
<br /><a href="pages/samples/new_pm.php?recip=<?php echo urlencode($dnn['nom']); ?>" class="btn btn-info"><i class="mdi  mdi-telegram"></i>Envoyer un MP à "<?php echo htmlentities($dnn['nom'], ENT_QUOTES, 'UTF-8'); ?>"</a>
<?php
}
	}
	else
