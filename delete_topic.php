...
?>
    ...
    <title>Supprimer un sujet - <?php echo htmlentities($dn1['title'], ENT_QUOTES, 'UTF-8'); ?> - <?php echo htmlentities($dn1['name'], ENT_QUOTES, 'UTF-8'); ?></title>
    <!-- plugins:css -->
...
{
    $requette= ('delete from topics where id="'.$id.'"');
